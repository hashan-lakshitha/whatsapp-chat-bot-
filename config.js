...
module.exports = {
    ...
    // Anti-ban settings
    REPLY_DELAY_MIN: parseFloat(process.env.REPLY_DELAY_MIN) || 1,          // minimum minutes before reply
    REPLY_DELAY_MAX: parseFloat(process.env.REPLY_DELAY_MAX) || 20,         // maximum minutes before reply
